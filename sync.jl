...
const posts = [
    # NEWEST TO OLDESTS
	Post("animating list shuffle with FLIP technique", "2024/12/25", "Animating a list shuffle with FLIP technique", [], "Explaining how to use the FLIP technique to animate a list shuffle"),
